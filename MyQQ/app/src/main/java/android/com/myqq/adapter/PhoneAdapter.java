...
public class PhoneAdapter extends BaseAdapter {
    ...
    public PhoneAdapter(Activity a, List<Music> d){
        activity = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
        {
            ...
            holder.iv = (ImageView)convertView.findViewById(R.id.item_phone_iv);
            holder.name = (TextView)convertView.findViewById(R.id.item_phone_name);
